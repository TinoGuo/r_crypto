...
void main() {
  ...
  group('verify hash', () {
    test('verify digest', () {
      expect(
        rCrypto.hashString(HashType.MD5, "hello"),
        hex.decode("5d41402abc4b2a76b9719d911017c592"),
      );
      expect(
        rCrypto.hashString(HashType.SHA1, "hello"),
        hex.decode("aaf4c61ddcc5e8a2dabede0f3b482cd9aea9434d"),
      );
      expect(
        rCrypto.hashString(HashType.SHA224, "hello"),
        hex.decode("ea09ae9cc6768c50fcee903ed054556e5bfc8347907f12598aa24193"),
      );
      expect(
        rCrypto.hashString(HashType.SHA256, "hello"),
        hex.decode(
            "2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824"),
      );
      expect(
        rCrypto.hashString(HashType.SHA384, "hello"),
        hex.decode(
            "59e1748777448c69de6b800d7a33bbfb9ff1b463e44354c3553bcdb9c666fa90125a3c79f90397bdf5f6a13de828684f"),
      );
      expect(
        rCrypto.hashString(HashType.SHA512, "hello"),
        hex.decode(
            "9b71d224bd62f3785d96d46ad3ea3d73319bfbc2890caadae2dff72519673ca72323c3d99ba5c11d7c7acc6e14b8c5da0c4663475c2e5c3adef46f73bcdec043"),
      );
      expect(
        rCrypto.hashString(HashType.SHA512_TRUNC224, "hello"),
        hex.decode("fe8509ed1fb7dcefc27e6ac1a80eddbec4cb3d2c6fe565244374061c"),
      );
      expect(
        rCrypto.hashString(HashType.SHA512_TRUNC256, "hello"),
        hex.decode(
            "e30d87cfa2a75db545eac4d61baf970366a8357c7f72fa95b52d0accb698f13a"),
      );
      expect(
        rCrypto.hashString(HashType.SHA3_224, "hello"),
        hex.decode("b87f88c72702fff1748e58b87e9141a42c0dbedc29a78cb0d4a5cd81"),
      );
      expect(
        rCrypto.hashString(HashType.SHA3_256, "hello"),
        hex.decode(
            "3338be694f50c5f338814986cdf0686453a888b84f424d792af4b9202398f392"),
      );
      expect(
        rCrypto.hashString(HashType.SHA3_384, "hello"),
        hex.decode(
            "720aea11019ef06440fbf05d87aa24680a2153df3907b23631e7177ce620fa1330ff07c0fddee54699a4c3ee0ee9d887"),
      );
      expect(
        rCrypto.hashString(HashType.SHA3_512, "hello"),
        hex.decode(
            "75d527c368f2efe848ecf6b073a36767800805e9eef2b1857d5f984f036eb6df891d75f72d9b154518c1cd58835286d1da9a38deba3de98b5a53e5ed78a84976"),
      );
      expect(
        rCrypto.hashString(HashType.KECCAK_224, "hello"),
        hex.decode("45524ec454bcc7d4b8f74350c4a4e62809fcb49bc29df62e61b69fa4"),
      );
      expect(
        rCrypto.hashString(HashType.KECCAK_256, "hello"),
        hex.decode(
            "1c8aff950685c2ed4bc3174f3472287b56d9517b9c948127319a09a7a36deac8"),
      );
      expect(
        rCrypto.hashString(HashType.KECCAK_384, "hello"),
        hex.decode(
            "dcef6fb7908fd52ba26aaba75121526abbf1217f1c0a31024652d134d3e32fb4cd8e9c703b8f43e7277b59a5cd402175"),
      );
      expect(
        rCrypto.hashString(HashType.shake(ExtensionHash.Shake128, 10), "hello"),
        hex.decode("8eb4b6a932f280335ee1"),
      );
      expect(
        rCrypto.hashString(HashType.shake(ExtensionHash.Shake256, 64), "hello"),
        hex.decode(
      ...
      expect(
        rCrypto.hashString(HashType.WHIRLPOOL, "hello"),
        hex.decode(
      ...
      expect(
        rCrypto.hashString(HashType.blake3(), "hello"),
        hex.decode(
            "ea8f163db38682925e4491c5e58d4bb3506ef8c14eb78a86e908c5624a67200f"),
      );
      expect(
        rCrypto.hashString(HashType.blake3(length: 64), "hello"),
        hex.decode(
    ...
    test('verify blake2', () {
      expect(
        rCrypto.blake2String(Blake2Type.blake2b(64), "hello"),
        hex.decode(
            "e4cfa39a3d37be31c59609e807970799caa68a19bfaa15135f165085e01d41a65ba1e1b146aeb6bd0092b49eac214c103ccfa3a365954bbbe52f74a2b3620c94"),
      );
      expect(
        rCrypto.blake2String(Blake2Type.blake2b(64), "hello", salt: [0, 1, 2]),
        hex.decode(
      ...
      expect(
        rCrypto.blake2String(Blake2Type.blake2s(32), "hello"),
        hex.decode(
